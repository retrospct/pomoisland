...
- The repo uses multiple linked git worktrees for parallel `cursor/` branches; after switching to a feature worktree use `move_agent_to_root` so file edits land in the correct tree.
